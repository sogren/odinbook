...
ActiveRecord::Schema.define(version: 20_151_222_183_625) do
  ...
  add_index "invitations", %w(invited_user_id inviting_user_id), name: "index_invitations_on_invited_user_id_and_inviting_user_id", unique: true
  ...
  add_index "likes", %w(likeable_id likeable_type liker_id), name: "likes_index", unique: true
